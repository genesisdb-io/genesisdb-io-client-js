...
export class Client {
  ...
  async streamEvents(subject: string, options?: StreamOptions) {
  ...
  async *observeEvents(subject: string, options?: StreamOptions): AsyncGenerator<CloudEvent<unknown>, void, unknown> {
